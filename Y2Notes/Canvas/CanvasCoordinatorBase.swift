...
/// Shared constants and helpers used by both CanvasView and CanvasPageView.
enum CanvasConstants {
    /// A4 paper aspect ratio (~1 : √2).
    static let a4AspectRatio: CGFloat = 1.414

    /// Fixed page size for the canvas content area.
    ...
    /// The background color shown outside the page boundaries.
