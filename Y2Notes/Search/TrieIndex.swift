...
final class TrieIndex {
    ...
    func indexDocument(id: UUID, text: String) {
    ...
    func prefixSearch(_ prefix: String) -> Set<UUID> {
    ...
    func fuzzySearch(_ query: String, maxDistance: Int = 1) -> [UUID: Int] {
    ...
    func rankedSearch(_ query: String, maxFuzzyDistance: Int = 1) -> [(id: UUID, score: Double)] {
