...
final class InkFamilyRegistry {
    ...
    private static func sheenPresets() -> [InkPreset] {[
        ...
        InkPreset(name: "Opal",
                  ...
                  baseWidth: 3.0, isBuiltIn: true),
        InkPreset(name: "Nebula",
                  family: .sheen, traits: .metallic, writingFX: .sheen,
                  color: UIColor(red: 0.40, green: 0.20, blue: 0.85, alpha: 1),
                  baseWidth: 3.5, isBuiltIn: true),
        InkPreset(name: "Stardust",
                  family: .sheen, traits: .metallic, writingFX: .sheen,
