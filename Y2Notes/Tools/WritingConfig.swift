...
struct ToolPersonality {
    ...
    let pkInkType: PKInkingTool.InkType
}
...
extension ToolPersonality {
    ...
    static let pen = ToolPersonality(
        minWidth: 0.5,
        maxWidth: 8.0,
        defaultWidth: 2.5,
        widthStep: 0.5,
    ...
    static let pencil = ToolPersonality(
        minWidth: 0.5,
        maxWidth: 12.0,
        defaultWidth: 3.0,
        widthStep: 0.5,
    ...
    static let highlighter = ToolPersonality(
        minWidth: 2.0,
        maxWidth: 15.0,
        defaultWidth: 5.0,
        widthStep: 1.0,
    ...
    static let fountainPen: ToolPersonality = {
        if #available(iOS 17, *) {
    ...
    static func personality(for tool: DrawingTool) -> ToolPersonality? {
        switch tool {
        case .pen:          return .pen
...
enum WritingConfig {
    ...
    static let lockZoomDuringWriting = true
    ...
    static let fingerMinPointThreshold = 3
    ...
    static let postPencilFingerGuardDelay: TimeInterval = 0.3
    ...
    static let useTouchTypeFiltering = true
    ...
    static let saveDebounceInterval: TimeInterval = 0.8
    ...
    static let tabSwitchSaveDebounce: TimeInterval = 1.5
    ...
    static let strokeCountWarningThreshold = 2000
    ...
    static let strokeCountHardLimit = 5000
    ...
    static let maxDrawingDataSize = 10_000_000
    ...
    static let tabSwitchCrossfadeDuration: TimeInterval = 0.2

    /// Duration of the page-turn crossfade within a notebook.
    static let pageTurnCrossfadeDuration: TimeInterval = 0.15
}
...
@MainActor
final class StrokePerformanceMonitor: ObservableObject {
    ...
    func update(strokeCount: Int, dataSize: Int) {
