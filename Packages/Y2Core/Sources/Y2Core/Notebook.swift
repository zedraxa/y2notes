...
public enum NotebookColorTag: String, CaseIterable, Codable {
    case none   = "none"
    case red    = "red"
    case orange = "orange"
    case teal   = "teal"
...
public enum NotebookCover: String, CaseIterable, Codable {
    case ocean
    case forest
    case sunset
    case lavender
    ...
    public var rgbComponents: [Double] {
        switch self {
...
public enum NotebookTemplate: String, CaseIterable, Identifiable {
    case blank
    case study
    case journal
    case planner
...
public struct Notebook: Identifiable, Codable, Hashable {
    public let id: UUID
    public var name: String
    public var description: String
    public var createdAt: Date
    public var modifiedAt: Date
    public var cover: NotebookCover
    public var pageType: PageType
    ...
    public static func == (lhs: Notebook, rhs: Notebook) -> Bool { lhs.id == rhs.id }
}
