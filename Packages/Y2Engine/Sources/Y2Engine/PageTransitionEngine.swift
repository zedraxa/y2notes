...
public enum PageTransitionDirection {
    ...
    public var sign: CGFloat { self == .forward ? 1.0 : -1.0 }
}
...
public final class PageTransitionEngine {
    ...
    public static func playNewPageReveal(on layer: CALayer) {
    ...
    public func beginInteractiveDrag(
        on view: UIView,
        direction: PageTransitionDirection,
        pageWidth: CGFloat
    ) {
    ...
    public func updateInteractiveDrag(
        on view: UIView,
        translation: CGFloat,
        pageWidth: CGFloat
    ) {
    ...
    public func finishInteractiveDrag(
        on view: UIView,
        velocityX: CGFloat,
        pageWidth: CGFloat,
    ...
    public func cancelInteractiveDrag(on view: UIView, completion: @escaping () -> Void) {
    ...
    ///   - completion: Called on the main thread when the transition finishes.
    public func playVelocityTransition(
        on layer: CALayer,
        direction: PageTransitionDirection,
        pageWidth: CGFloat,
        velocity: CGFloat,
    ...
    public func updateInteractiveDrag(on layer: CALayer, translation: CGFloat) {
    ...
    public func cancelInteractiveDrag(on layer: CALayer, completion: @escaping () -> Void) {
