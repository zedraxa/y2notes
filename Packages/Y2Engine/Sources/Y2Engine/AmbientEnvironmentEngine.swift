...
public enum AmbientScene: String, CaseIterable, Identifiable {
...
public final class AmbientEnvironmentEngine {
    ...
    public private(set) var activeScene: AmbientScene?
...
private final class NoiseState {
    ...
    public var b0: Float = 0, b1: Float = 0, b2: Float = 0
    public var b3: Float = 0, b4: Float = 0, b5: Float = 0
    // Brown-noise integrator.
    public var bnLastOut: Float = 0
    // Lo-fi LFO phase (radians).
    public var lfoPhase: Float = 0
    // LCG PRNG state — fast, lock-free, suitable for audio thread.
    public var lcgState: UInt32 = 2_463_534_242
