...
public enum DeviceCapabilityTier: Int, Codable, Comparable {
    ...
    public static func < (lhs: DeviceCapabilityTier, rhs: DeviceCapabilityTier) -> Bool {
    ...
    public var supportsRealtimeFX: Bool { self >= .pro }

    /// Whether *any* overlay FX should be created (avoids even allocating layers on .basic).
    public var supportsAnyFX: Bool { self >= .standard }
}
...
public enum InkFamily: String, CaseIterable, Codable, Identifiable {
...
public struct InkMaterialTraits: Codable, Equatable {
    ...
    public static let standard   = InkMaterialTraits(isDry: false, wetness: 0.2,
                                               sheenAmount: 0.0, viscosity: 0.5, granularity: 0.1)
    public static let dry        = InkMaterialTraits(isDry: true,  wetness: 0.0,
                                               sheenAmount: 0.0, viscosity: 0.2, granularity: 0.6)
    public static let wet        = InkMaterialTraits(isDry: false, wetness: 0.8,
                                               sheenAmount: 0.0, viscosity: 0.8, granularity: 0.05)
    public static let metallic   = InkMaterialTraits(isDry: false, wetness: 0.3,
                                               sheenAmount: 0.9, viscosity: 0.5, granularity: 0.02)
    public static let watercolor = InkMaterialTraits(isDry: false, wetness: 0.9,
...
public enum WritingFXType: String, CaseIterable, Codable, Identifiable {
...
public struct ParticlePhysics: Equatable {
    ...
    public var gravity: CGFloat = 0
    /// Horizontal drift acceleration (points/s²).
    public var wind: CGFloat = 0
    ...
    public var attractorStrength: CGFloat = 0
    ...
    public var noiseFrequency: CGFloat = 0
    ...
    public var noiseAmplitude: CGFloat = 0
    ...
    public static let fireCorePhysics = ParticlePhysics(
    ...
    public static let fireEmberPhysics = ParticlePhysics(
    ...
    public static let sparklePhysics = ParticlePhysics(
    ...
    public static let snowPhysics = ParticlePhysics(
    ...
    public static let dissolvePhysics = ParticlePhysics(
    ...
    public static let rainbowPhysics = ParticlePhysics(
        gravity: 0,
        wind: 0,
        turbulence: 10,
        drag: 0.95,
    ...
    public static let glowPhysics = ParticlePhysics(
        gravity: 0,
        wind: 0,
        turbulence: 5,
        drag: 0.98,
    ...
    public static let sheenCorePhysics = ParticlePhysics(
    ...
    public static let sheenFlarePhysics = ParticlePhysics(
    ...
    public static let sheenDustPhysics = ParticlePhysics(
    ...
    public static let shadowPhysics = ParticlePhysics(
    ...
    public static let shadowWispPhysics = ParticlePhysics(
    ...
    public static let bloodPhysics = ParticlePhysics(
...
public struct InkPreset: Identifiable, Codable, Equatable {
    public var id: UUID
    public var name: String
    public var family: InkFamily
    public var traits: InkMaterialTraits
    public var writingFX: WritingFXType
