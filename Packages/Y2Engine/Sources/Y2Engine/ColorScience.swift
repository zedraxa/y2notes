...
public struct OKLab: Equatable {
    ...
    public static func fromLCH(L: Double, C: Double, h: Double) -> OKLab {
...
public enum ColorHarmony {
    ...
    public static func complementary(of color: UIColor) -> UIColor {
        rotateHue(color, by: .pi)
    }

    /// Analogous: two neighbors at ±30° on the hue wheel.
    public static func analogous(of color: UIColor, spread: Double = .pi / 6) -> (leading: UIColor, trailing: UIColor) {
        return (
    ...
    public static func triadic(of color: UIColor) -> (second: UIColor, third: UIColor) {
        return (
    ...
    public static func splitComplementary(of color: UIColor, spread: Double = .pi / 6) -> (leading: UIColor, trailing: UIColor) {
        return (
    ...
    public static func tetradic(of color: UIColor) -> (second: UIColor, third: UIColor, fourth: UIColor) {
        return (
...
public enum ContrastRatio {
    ...
    public static func meetsAA(_ foreground: UIColor, _ background: UIColor) -> Bool {
        ratio(foreground, background) >= 4.5
    }

    /// Whether the pair meets WCAG AAA for normal text (≥ 7:1).
    public static func meetsAAA(_ foreground: UIColor, _ background: UIColor) -> Bool {
    ...
    public static func accessibleShade(
        of color: UIColor,
...
public enum ColorDistance {
    ...
    public static func isPerceptuallyEqual(_ a: UIColor, _ b: UIColor, threshold: Double = 0.02) -> Bool {
        deltaE(a, b) < threshold
    }

    /// Find the most distinct color in a palette from a reference color.
    public static func mostDistinct(from reference: UIColor, in palette: [UIColor]) -> UIColor? {
