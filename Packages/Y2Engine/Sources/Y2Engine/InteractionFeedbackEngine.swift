...
public enum InteractionEvent: String, CaseIterable {
...
/// ```
public final class InteractionFeedbackEngine {
    ...
    public func play(_ event: InteractionEvent, on layer: CALayer? = nil) {
    ...
    public func updateZoom(_ zoomScale: CGFloat, on layer: CALayer? = nil) {
