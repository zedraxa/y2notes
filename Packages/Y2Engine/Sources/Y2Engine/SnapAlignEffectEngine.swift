...
public enum SnapAlignEffectType: String, CaseIterable {
...
public final class SnapAlignEffectEngine {
    ...
    public func playLineGuideFlash(
    ...
    public func updatePerfectAlignment(isAligned: Bool) {
